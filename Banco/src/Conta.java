public abstract class Conta {
    ...
    public void sacar(double valor) {
        if (getSaldo() < valor) {
            System.out.println(getTitularConta() + ", saldo da conta insuficiente para saque.");
        } else {
            setSaldo(getSaldo() - valor);
            System.out.printf("%s%s%.2f%n", getTitularConta(), ", saque efetuado com sucesso. Seu novo saldo da conta é: ", getSaldo());
        }
    }
